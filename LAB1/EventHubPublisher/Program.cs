namespace EventHubPublisher
{
	...
	{
		private const string EventHubConnectionString = "Endpoint=sb://matfyzeventhub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=NFEsIiDw9gTOFsIl1JCsPo4fwy1p6STrQ0+ANlNEwd4="; // ie Endpoint=sb://XXX.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=XXX
		private const string EventHubName = "matfyzeventhub"; // ie myeventhub1
